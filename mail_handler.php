...
$mail->From = 'collin.server.email@gmail.com';  // sender's email address (shows in "From" field)
$mail->FromName = 'mailer daemon';   // sender's name (shows in "From" field)
$mail->addAddress('cstewa91@gmail.com', 'First Recipient\'s name');  // Add a recipient (name is optional)
